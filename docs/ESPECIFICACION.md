...
- **Afinado visual (tanda 1, auditoría de diseño):** reglas aplicadas para separar el look genérico del diseñado, cada una con su porqué —
  ...
  - *Tres niveles de acción, no uno*: «Nuevo ítem» (acento) > «Categorías» (contorno, gobierna la leyenda a su lado) > IA/Apariencia/Cerrar sesión (fantasma: sin borde ni fondo). Se enfatiza des-enfatizando lo terciario, no amplificando lo primario.
